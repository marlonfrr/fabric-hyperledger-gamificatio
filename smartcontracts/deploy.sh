...
#Remove in /home/fabric/workspace/fabric2_hello_world/network/test-network/organizations/peerOrganizations/org1.example.com/connection-org1.json
#"ssl-target-name-override": "peer0.org1.example.com",


#DEBUG
# CORE_CHAINCODE_ID_NAME=fabcar_1:90b33ed49df58cd9b43bc3e18877eacfce48ba845ca0fd1e0cc55413e49b28db CORE_PEER_TLS_ENABLED=false node ./index.js --peer.address 127.0.0.1:7052
